...
#
# --reasoning-budget 0: Qwen3.8 still emits <think> even when the template
# does not start thinking; close it immediately so the model can tool-call.
# --reasoning-format deepseek: strip think tags out of Claude Code's text.
